...
const styles = StyleSheet.create({
  ...
  header: { padding: spacing.lg, backgroundColor: colors.primaryDark, borderWidth: 1, borderColor: colors.line, borderRadius: radii.lg, marginBottom: 20 },
  step: { fontSize: 10, fontWeight: "800", color: colors.primary, letterSpacing: 1.1 },
  headerStep: { fontSize: 10, fontWeight: "800", color: colors.muted, letterSpacing: 1.1 },
  title: { fontSize: 30, lineHeight: 36, fontWeight: "800", color: colors.ink, marginTop: 12 },
  body: { fontSize: 13, lineHeight: 20, color: colors.muted, marginTop: 7 },
  headerBody: { fontSize: 13, lineHeight: 20, color: colors.muted, marginTop: 7 },
  ...
  support: { borderColor: colors.warn, backgroundColor: colors.warnSoft },
  ...
  validate: { minHeight: 48, alignItems: "center", justifyContent: "center", backgroundColor: colors.primary, borderRadius: radii.sm, marginTop: 20, paddingHorizontal: 14 },
