    ...
    <main className="shell">
      ...
      <section className="content">
        ...
        <section className="bottom-grid" id="team">
          ...
          <article className="week-card"><div className="card-top"><div><span className="eyebrow">RYTHME DE LA SEMAINE</span><h3>2 temps forts</h3></div><span className="mini-badge">S33</span></div><div className="timeline"><div><span className="dot filled"/><p><strong>Mardi</strong><small>Séance · 18:00</small></p></div><div><span className="dot"/><p><strong>Samedi</strong><small>Match vs. US Vallée · 10:30</small></p></div></div><Link className="match-observation-link" href="/match">Préparer un match →</Link></article>
        </section>
      </section>
    </main>
  );
